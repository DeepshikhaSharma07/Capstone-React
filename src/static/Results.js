...
const Results = ({ movieState, back, backButtState }) => {
  ...
  async function getUser() {
    const response = await fetch("https://movie-app-backend-springboot.herokuapp.com/users/login", {
      method: "GET",
      credentials: "include",
    });
  ...
  async function saveMovie() {
    ...
    const response = await fetch("https://movie-app-backend-springboot.herokuapp.com/users/favorites", {
      method: "POST",
      credentials: "include",
